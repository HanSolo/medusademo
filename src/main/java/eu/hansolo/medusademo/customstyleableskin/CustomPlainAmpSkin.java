...
package eu.hansolo.medusademo.customstyleableskin;
...
public class CustomPlainAmpSkin extends GaugeSkinBase {
    ...
    // ******************** Constructors **************************************
    public CustomPlainAmpSkin(StyleableGauge gauge) {
        super(gauge);

        gauge.getStylesheets().add(CustomPlainAmpSkin.class.getResource("custom-plain-amp.css").toExternalForm());
    ...
    @Override protected void registerListeners() {
        ...
        if (gauge instanceof StyleableGauge) {
            ((StyleableGauge) gauge).styleableTickmarkColorProperty().addListener((o, ov, nv) -> gauge.setTickMarkColor(nv));
            ((StyleableGauge) gauge).styleableTicklabelColorProperty().addListener((o, ov, nv) -> gauge.setTickLabelColor(nv));
        }
    }
