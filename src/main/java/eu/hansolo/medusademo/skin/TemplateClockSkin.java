...
package eu.hansolo.medusademo.skin;
 ...
 */
public class TemplateClockSkin extends SkinBase<Clock> implements Skin<Clock> {
    ...
    // ******************** Constructors **************************************
    public TemplateClockSkin(Clock clock) {
        super(clock);
    ...
    private void registerListeners() {
        ...
        getSkinnable().addClockObserver(MedusaEvt.FINISHED, e -> handleEvents(e.getEvtType().getName()));
    }
    ...
    private void resize() {
        ...
        if (width > 0 && height > 0) {
            ...
            // Resize and relocate elements here
