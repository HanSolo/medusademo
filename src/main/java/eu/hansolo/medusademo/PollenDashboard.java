...
public class PollenDashboard extends Application {
    ...
    @Override public void init() {
        GaugeBuilder builder = GaugeBuilder.create()
                                           ...
                                           .sections(SectionBuilder.create().start(0).stop(33).color(Color.rgb(34, 180, 11)).text("Sec 1").build(),
                                                     SectionBuilder.create().start(33).stop(66).color(Color.rgb(255, 146, 0)).text("Sec 2").build(),
                                                     SectionBuilder.create().start(66).stop(100).color(Color.rgb(255, 0, 39)).text("Sec 3").build());
